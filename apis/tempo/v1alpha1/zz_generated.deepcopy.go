...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerfSpec) DeepCopyInto(out *PerfSpec) {
	*out = *in
	if in.Ballast != nil {
		in, out := &in.Ballast, &out.Ballast
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerfSpec.
func (in *PerfSpec) DeepCopy() *PerfSpec {
	if in == nil {
		return nil
	}
	out := new(PerfSpec)
