...
func start(c *cobra.Command, args []string) {
	...
	setupLog.Info("Starting Tempo Operator",
		...
		"tempo-image", rootCmdConfig.CtrlConfig.Images.Tempo,
		"tempo-query-image", rootCmdConfig.CtrlConfig.Images.TempoQuery,
		"tempo-gateway-image", rootCmdConfig.CtrlConfig.Images.TempoGateway,
		"tempo-gateway-opa-image", rootCmdConfig.CtrlConfig.Images.TempoGatewayOpa,
